...
$.validator.addMethod("dateHour", function(value, element) {
	return this.optional(element) || /^\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2} \d{2}:\d{2}$/.test(value);
}, '请输入有效的日期(YYYY-MM-DD HH:mm)!');
$.validator.addMethod("datetimeOrZero", function(value, element) {
	return this.optional(element) || /^\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2} \d{2}:\d{2}:\d{2}$/.test(value);
}, '请输入有效的日期(YYYY-MM-DD HH:mm:ss)或者0立即开始!');
$.validator.addMethod("datetime", function(value, element) {
	return this.optional(element) || /^\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2} \d{2}:\d{2}:\d{2}$/.test(value);
}, '请输入有效的日期(YYYY-MM-DD HH:mm:ss)!');